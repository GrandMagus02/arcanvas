import type { CustomDrawConfig, ShaderProvider, ShaderSource } from "@arcanvas/backend-webgl";
import { ShaderRegistry } from "@arcanvas/backend-webgl";
import type { BaseMaterial } from "@arcanvas/graphics";
import { TransformationMatrix, toColumnMajor4x4 } from "../../utils/matrixUtils";
